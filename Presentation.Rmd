...
\pause
```{r, fig.cap = "Zusammenhang zwischen Studierendenquote und sozialer Ungleichheit beim Zugang zu Hochschulbildung",echo = F,warning = F, message = F, , out.height= "5cm"}
...
```{r, fig.cap = "Modell des Hochschulsystems und Wechselwirkungen",echo = F,warning = F, message = F}
...
\item{Schätzstrategie: Hierarchische lineare Regression mit Random Intercepts und gruppenspezifische Mittelwertszentrierung (Bell \& Jones 2015, Shor et al. 2007)
\newline
...
## Paper #3: *The Role of Parties in the Distributive Politics of Higher Education* (Ergebnisse)
